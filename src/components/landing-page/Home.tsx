...
const JoinWaitingListBtn = styled.div`
  display: flex;
  margin-bottom: 30px;
`;
  ...
  return (
    <Wrapper>
      <IntroWrapperText>
        ...
        <p>
          Plataforma online que te permite coordinar fácilmente tus operaciones
        ...
        <p>
          ...
          sobrecostos y estrés laboral gracias a que ahora podrás controlar
          mejor las actividades de tu área de comercio exterior.
        </p>
      </IntroWrapperText>
      <IntroImage>
      ...
      <BenefitsWrapper className="benefits">
        <BenefitsList className="list-benefits">
          ...
          <div className="benefit">
            ...
            <p>
              Ya no se te pasará por alto realizar aquella actividad que pondrá
              en riesgo tu exportación. En cada etapa de la cadena de
              distribución física internacional puedes gestionar las actividades
              previamente creadas o aquellas especificas de cada operación.
            </p>
          </div>
          <div className="benefit">
